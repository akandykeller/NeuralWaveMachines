...
class coRNNCell(nn.Module):
    def __init__(self, n_inp, spatial, dt, gamma, epsilon):
        ...
        self.Wz = nn.Conv2d(1, 1, (1,3), padding=(0,1), padding_mode='circular', bias=False).to(device)
        self.Wy = nn.Conv2d(1, 1, (1,3), padding=(0,1), padding_mode='circular', bias=False).to(device)
